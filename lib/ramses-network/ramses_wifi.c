...
#if WIFI_SAE_MODE == WPA3_SAE_PWE_HUNT_AND_PECK
#define SAE_MODE WPA3_SAE_PWE_HUNT_AND_PECK
#define H2E_IDENTIFIER ""
#elif WIFI_SAE_MODE == WPA3_SAE_PWE_HASH_TO_ELEMENT
#define SAE_MODE WPA3_SAE_PWE_HASH_TO_ELEMENT
#define H2E_IDENTIFIER CONFIG_WIFI_PW_ID
#elif WIFI_SAE_MODE == WPA3_SAE_PWE_BOTH
#define SAE_MODE WPA3_SAE_PWE_BOTH
#define H2E_IDENTIFIER CONFIG_WIFI_PW_ID
#endif

#if WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_OPEN
#define SCAN_AUTH_MODE_THRESHOLD WIFI_AUTH_OPEN
#elif WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_WEP
#define SCAN_AUTH_MODE_THRESHOLD WIFI_AUTH_WEP
#elif WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_WPA_PSK
#define SCAN_AUTH_MODE_THRESHOLD WIFI_AUTH_WPA_PSK
#elif WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_WPA2_PSK
#define SCAN_AUTH_MODE_THRESHOLD WIFI_AUTH_WPA2_PSK
#elif WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_WPA_WPA2_PSK
#define SCAN_AUTH_MODE_THRESHOLD WIFI_AUTH_WPA_WPA2_PSK
#elif WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_WPA3_PSK
#define SCAN_AUTH_MODE_THRESHOLD WIFI_AUTH_WPA3_PSK
#elif WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_WPA2_WPA3_PSK
#define SCAN_AUTH_MODE_THRESHOLD WIFI_AUTH_WPA2_WPA3_PSK
#elif WIFI_SCAN_AUTH_MODE_THRESHOLD == WIFI_AUTH_WAPI_PSK
...
static void wifi_event_handler(void* arg, esp_event_base_t event_base, int32_t event_id, void* event_data)
{
    ...
    if (event_base == WIFI_EVENT && event_id == WIFI_EVENT_STA_START) {
        ...
        if (ctxt->retry_num < WIFI_MAXIMUM_RETRY) {
            esp_wifi_connect();
            ctxt->retry_num++;
...
WIFI_HNDL ramses_wifi_init(BaseType_t coreID)
{
    ...
    esp_log_level_set(TAG, WIFI_LOG_LEVEL);
