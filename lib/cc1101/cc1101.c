...
#if SPI_HOST == CC_SPI2_HOST
#define CC_HOST_ID SPI2_HOST
#elif SPI_HOST == CC_SPI3_HOST
#define CC_HOST_ID SPI3_HOST
#endif

static spi_bus_config_t const cc_buscfg = {
    .sclk_io_num = CC_SCK_GPIO, // set SPI CLK pin
    .mosi_io_num = CC_MOSI_GPIO, // set SPI MOSI pin
    .miso_io_num = CC_MISO_GPIO, // set SPI MISO pin
    .quadwp_io_num = -1,
    .quadhd_io_num = -1
};
...
#define cc_assert() gpio_set_level(CC_CSN_GPIO, LOW)
#define cc_deassert() gpio_set_level(CC_CSN_GPIO, HIGH)
